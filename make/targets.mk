...
ifeq ($(filter $(TARGET), $(F4_TARGETS) $(F7_TARGETS) $(G4_TARGETS) $(H7_TARGETS) $(SITL_TARGETS) $(RP2350_TARGETS)),)
$(error Target '$(TARGET)' has not specified a valid STM group, must be one of F405, F411, F446, F7X2RE, F7X5XE, F7X5XG, F7X5XI, F7X6XG, G47X, H7X3XI or RP2350A/RP2350B/RP2354A/RP2354B. Have you prepared a valid target.mk?)
endif
...
else ifeq ($(TARGET),$(filter $(TARGET), $(RP2350_TARGETS)))
TARGET_MCU := RP2350
