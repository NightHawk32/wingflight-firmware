/**
  ...
  *
  *           Ported near-verbatim from Artery's own vendored
  *           lib/main/AT32F43x/cmsis/cm4/device_support/startup/gcc/startup_at32f435_437.s.
  *           Unlike STM32F4's startup_stm32f40xx.s, no persistentObjectInit/
  *           checkForBootLoaderRequest calls are made from assembly here -- AT32's
  *           drivers/system_at32f43x.c systemInit() calls both itself from C
  *           (matching the STM32F7/H7/G4 HAL-platform convention, not F4's).
  ******************************************************************************
  */
...
/******************************************************************************
*
* The AT32F435/437 vector table for gcc toolchain.
*
*******************************************************************************/
