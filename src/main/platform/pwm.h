...
// Ported from betaflight's src/platform/PICO/include/platform/pwm.h.
// Small per-output bookkeeping struct shared by drivers/pwm_motor_pico.c
// (and any future PICO PWM-slice based output driver).
