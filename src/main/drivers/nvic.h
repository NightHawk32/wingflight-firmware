...
// AT-BSP's NVIC_PRIORITY_GROUP_n values are already the raw PRIGROUP field (same encoding
// as the HAL's NVIC_PRIORITYGROUP_n), so this reuses the HAL branch's (unshifted) math.
