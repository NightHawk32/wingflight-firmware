...
// Real AT32F435/437 UART1-8 pin/AF, RCC and DMAMUX-request-ID data, ported from
// betaflight's own AT32 port (betaflight/src/platform/AT32/serial_uart_at32f43x.c),
// restructured to Wingflight's older uartHardware_t field names (.device/.reg/
// .rxDMAChannel/.txDMAChannel/.irqn instead of .identifier/.rxDMAMuxId/.txDMAMuxId).
//
// NOTE: dma_reqmap.c's AT32 DMAMUX request-ID resolution table (consumed via
// USE_DMA_SPEC) currently only covers UART1-5, matching STM32G4 parity. UART6/7/8
// below still get their real DMAMUX_DMAREQ_ID_* here (used if a board ever hardcodes
// a DMA channel via the UARTn_xx_DMA_CHANNEL override macros below), but CLI-driven
// "dma" resource assignment for them will not work until dma_reqmap.c is extended.
...
const uartHardware_t uartHardware[UARTDEV_COUNT] = {
#ifdef USE_UART1
    {
        ...
        .reg = USART1,
#ifdef USE_DMA
        .rxDMAChannel = DMAMUX_DMAREQ_ID_USART1_RX,
        .rxDMAResource = (dmaResource_t *)UART1_RX_DMA_CHANNEL,
        .txDMAChannel = DMAMUX_DMAREQ_ID_USART1_TX,
...
#ifdef USE_UART2
    {
        ...
        .reg = USART2,
#ifdef USE_DMA
        .rxDMAChannel = DMAMUX_DMAREQ_ID_USART2_RX,
        .rxDMAResource = (dmaResource_t *)UART2_RX_DMA_CHANNEL,
        .txDMAChannel = DMAMUX_DMAREQ_ID_USART2_TX,
...
#ifdef USE_UART3
    {
        ...
        .reg = USART3,
#ifdef USE_DMA
        .rxDMAChannel = DMAMUX_DMAREQ_ID_USART3_RX,
        .rxDMAResource = (dmaResource_t *)UART3_RX_DMA_CHANNEL,
        .txDMAChannel = DMAMUX_DMAREQ_ID_USART3_TX,
...
#ifdef USE_UART4
    {
        ...
        .reg = UART4,
#ifdef USE_DMA
        .rxDMAChannel = DMAMUX_DMAREQ_ID_UART4_RX,
        .rxDMAResource = (dmaResource_t *)UART4_RX_DMA_CHANNEL,
        .txDMAChannel = DMAMUX_DMAREQ_ID_UART4_TX,
...
#ifdef USE_UART5
    {
        ...
        .reg = UART5,
#ifdef USE_DMA
        .rxDMAChannel = DMAMUX_DMAREQ_ID_UART5_RX,
        .rxDMAResource = (dmaResource_t *)UART5_RX_DMA_CHANNEL,
        .txDMAChannel = DMAMUX_DMAREQ_ID_UART5_TX,
...
#ifdef USE_UART6
    {
        ...
        .reg = USART6,
#ifdef USE_DMA
        .rxDMAChannel = DMAMUX_DMAREQ_ID_USART6_RX,
        .rxDMAResource = (dmaResource_t *)UART6_RX_DMA_CHANNEL,
        .txDMAChannel = DMAMUX_DMAREQ_ID_USART6_TX,
...
#ifdef USE_UART7
    {
        ...
        .reg = UART7,
#ifdef USE_DMA
        .rxDMAChannel = DMAMUX_DMAREQ_ID_UART7_RX,
        .rxDMAResource = (dmaResource_t *)UART7_RX_DMA_CHANNEL,
        .txDMAChannel = DMAMUX_DMAREQ_ID_UART7_TX,
...
#ifdef USE_UART8
    {
        ...
        .reg = UART8,
#ifdef USE_DMA
        .rxDMAChannel = DMAMUX_DMAREQ_ID_UART8_RX,
        .rxDMAResource = (dmaResource_t *)UART8_RX_DMA_CHANNEL,
        .txDMAChannel = DMAMUX_DMAREQ_ID_UART8_TX,
