...
Note: this mode requires a current sensor. If you don't have the actual device you can set up a virtual current sensor (see [Battery](https://doc.wingflight.org/configurator/tabs/power/)).
