...
Smooth the AUTOHOVER transition into vertical with a two-stage roll lock, and lower the default autohover max_rate from 300 to 120 deg/s so engaging in forward flight makes a wider turn.
